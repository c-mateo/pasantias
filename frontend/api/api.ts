...
const courses = {
    get: withGetById<Course>("/courses"),
    list: withList<Course>("/courses"),
    create: withCreate<Course>("/courses"),
    update: withUpdate<Course>("/courses"),
    delete: withDelete<Course>("/courses")
}
