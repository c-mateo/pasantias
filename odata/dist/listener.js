...
function performComparison(operator, a, b) {
    switch (operator) {
        case "eq":
            return a === b;
        case "ne":
...
function performStringFunction(stack, functionName) {
...
function createComparisonCriteria(operator, identifier, literal) {
...
export class MyTreeWalker extends MyGrammarListener {
    ...
    exitList = (ctx) => {
        ...
        for (let i = 0; i < count; i++) {
            ...
            items.unshift(literalNode.value);
        }
